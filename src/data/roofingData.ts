...
export const TOP_PRIORITY_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    name: 'Comprehensive Leak Detection & Roof Repairs',
    category: 'tile-tin',
    isPriority: true,
    badge: 'Priority Service',
    tagline: 'Precision leak tracing to halt water ingress before costly structural damage.',
    description:
      'Targeted dispatch across local suburbs to locate elusive water entry points, halt internal ceiling damage, and deliver immediate weatherproofing followed by permanent restoration.',
    details: [
      'Specialist inspection crew equipped to locate hidden moisture paths',
      'Advanced tracing of flashing faults, wind-driven moisture, and capillary action',
      'Immediate weatherproofing, temporary seals, and structural containment',
...
export const BEFORE_AFTER_PROJECTS: ProjectShowcase[] = [
  {
    id: 'proj-featured',
    title: 'Complete Aerial Tile & Tin Roof Rejuvenation',
    category: 'Featured Transformation',
    location: 'Melbourne Residential Property',
    roofType: 'Concrete Tile',
    problem: 'Decades of severe UV fading, weathered porous tiles, deteriorated ridge pointing, and weathered adjoining tin sheets.',
  ...
  {
    id: 'proj-3',
    title: 'Storm Leak Detection & Valley Replacement',
    category: 'Leak Detection & Roof Repair',
    ...
    solution: 'Rapid dispatch, temporary storm seal applied, followed by new heavy-gauge Colorbond valley iron and weep hole installation.',
